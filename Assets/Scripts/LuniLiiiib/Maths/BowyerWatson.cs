    ...
    public sealed class BowyerWatson
    {
        ...
        public readonly struct Triangle
        {
            public Triangle(Vector2 a, Vector2 b, Vector2 c)
            {
                ...
                Vector2 sqrA = new(a.x * a.x, a.y * a.y);
                Vector2 sqrB = new(b.x * b.x, b.y * b.y);
                Vector2 sqrC = new(c.x * c.x, c.y * c.y);
                ...
                this.circumcenter = new Vector2(x, y);

                // Compute circumradius (must be done AFTER circumcenter).
                this.circumradius = (this.circumcenter - a).magnitude;
            }
            
            // Circumcircle data.
            private readonly Vector2 circumcenter;
            private readonly float circumradius;
            ...
            {
                return (this.circumcenter - point).magnitude <= this.circumradius;
            }
        }
        ...
        private Triangle ComputeSuperTriangle(IReadOnlyList<Vector2> points)
        {
            ...
            Vector2 a = new(x1, y1);
            Vector2 b = new(x2, y2);
            Vector2 c = new(xCenter, yCenter + dMax);
