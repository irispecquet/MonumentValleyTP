...
namespace LuniLib.Extensions
{
    public static class VectorExtensions
    {
        ...
        public static float Random(this Vector2 v) => Extensions.Random.Float(v.x, v.y);
        ...
        /// <returns>Randomly generated number.</returns>
        public static int Random(this Vector2Int v, bool inclusive = true) => Extensions.Random.Int(v.x, v.y + (inclusive ? 1 : 0));
